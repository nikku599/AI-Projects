...
A conversational AI chatbot that represents a professional on their personal website. This project uses OpenAI's GPT-4 API to create an intelligent assistant that can answer questions about a person's career, background, skills, and experience.
...
4. Attempts to collect user contact information through conversation
5. Sends notifications via Pushover when important interactions occur
...
The chatbot launches with an initial greeting and handles multi-turn conversations, automatically processing tool calls for recording user details and questions.
